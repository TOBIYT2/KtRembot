...
┗━━━━━━━━━━━━━━━━━━⬣\n`
    ...
    await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
            externalAdReply: {
                title: '⊱『🏎️𝆺𝅥 𝗥𝗘𝗚𝗜𝗦𝗧𝗥𝗔𝗗𝗢(𝗔) 𝆹𝅥🏎️』⊰',
                body: dev,
                thumbnailUrl: 'https://files.catbox.moe/va9rbl.jpg',
...
handler.help = ['adodes']
handler.tags = ['rg']
handler.command = ['verify', 'verificar', 'adodes', 'registrarse', 'registrar']
